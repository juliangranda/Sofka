...
public class Ejercicio2 {
	...
	public static void ingresos(int vectorBultos[] ) {
		//precioBulto = valorKgBulto(pesoBulto);
		int ingresos = 0;
		int ingresosDolares = 0;
		int precioDolar = 3000;
		
		
		for (int i = 0; i < vectorBultos.length; i++) {
			ingresos = ingresos + valorKgBulto(vectorBultos[i]);
			
		}
		ingresosDolares = (ingresos / precioDolar);
		
		System.out.println("ingresos en pesos: " + ingresos);
		System.out.println("ingresos en dolares: " + ingresosDolares);
